...
theme.set_highlights = function()
  ...
  hl(0, "Variable", { fg = c.yellow1, bg = 'NONE' })
  ...
  hl(0, "PreProc", { fg = c.gray3, bg = 'NONE' })
  hl(0, "Define", { fg = c.gray3, bg = 'NONE' })
  hl(0, "Macro", { fg = c.purple, bg = 'NONE' })
  hl(0, "Include", { fg = c.gray3, bg = 'NONE' })
  hl(0, "PreCondit", { fg = c.purple, bg = 'NONE' })
  hl(0, "Type", { fg = c.blue2, bg = 'NONE' })
  hl(0, "Class", { fg = c.orange2, bg = 'NONE' })
  hl(0, "StorageClass", { fg = c.orange1, bg = 'NONE' })
  hl(0, "Structure", { fg = c.orange1, bg = 'NONE' })
  hl(0, "Typedef", { fg = c.orange1, bg = 'NONE' })
  ...
  hl(0, "BufferInactive", { fg = c.gray, bg = c.bg1 })
  hl(0, "BufferInactiveIndex", { fg = c.gray, bg = c.bg1 })
  hl(0, "BufferInactiveMod", { fg = '#a58354', bg = c.bg1 })
  hl(0, "BufferInactiveSign", { fg = c.bg3, bg = c.bg1 })
  ...
  hl(0, "CmpDocumentationBorder", { fg = c.bg3, bg = c.bg1 })
